(function () {
    ...
    IDRViewer.on('ready', function (data) {
        ...
        d('btnRotateCw').addEventListener('click', function(e) { IDRViewer.rotate(90); e.preventDefault(); });
